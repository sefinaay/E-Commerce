...
@section('head')
<style>
.product-wrap{max-width:1000px;margin:2rem auto;padding:0 1rem;}
.product-detail{display:grid;grid-template-columns:1fr 1fr;gap:3rem;background:white;border:1px solid var(--border);border-radius:16px;padding:2rem;margin-bottom:2rem;}
.product-img{width:100%;border-radius:12px;object-fit:cover;max-height:400px;}
.product-brand{font-size:.8rem;color:var(--gold);font-weight:600;text-transform:uppercase;letter-spacing:.5px;}
.product-title{font-family:'Cormorant Garamond',serif;font-size:2rem;margin:.5rem 0;}
.product-price{color:var(--rose);font-size:1.8rem;font-weight:700;margin:1rem 0;}
.product-desc{color:#666;line-height:1.7;font-size:.9rem;margin-bottom:1.5rem;}
.stock-badge{display:inline-block;padding:.25rem .75rem;border-radius:50px;font-size:.75rem;font-weight:600;margin-bottom:1rem;}
.qty-wrap{display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;}
.qty-input{width:60px;text-align:center;padding:.5rem;border:1.5px solid var(--border);border-radius:8px;font-size:1rem;}
.reviews-section{background:white;border:1px solid var(--border);border-radius:16px;padding:2rem;}
...
<div class="product-wrap">
  <div class="product-detail" id="product-detail"><p style="color:#999">Memuat...</p></div>
  <div class="reviews-section">
    <h3 style="font-family:'Cormorant Garamond',serif;font-size:1.5rem;margin-bottom:1rem">Ulasan Produk</h3>
    <div id="review-form-wrap" style="background:var(--soft);border-radius:12px;padding:1.5rem;margin-bottom:1.5rem;display:none">
      <h4 style="margin-bottom:1rem">Tulis Ulasan</h4>
      <div style="margin-bottom:.75rem">
        <label style="font-size:.8rem;font-weight:600;color:#666;display:block;margin-bottom:.4rem">Rating</label>
        <select id="r-rating" style="padding:.5rem;border:1.5px solid var(--border);border-radius:8px;font-family:inherit">
      ...
      <div><textarea id="r-comment" style="width:100%;padding:.7rem;border:1.5px solid var(--border);border-radius:8px;font-family:inherit;resize:none" rows="3" placeholder="Ceritakan pengalaman Anda..."></textarea></div>
